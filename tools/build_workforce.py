    ...
    <div class="p-grid p-grid-8-4">
      ...
      <div class="p-grid">
        ...
        <div class="p-card p-stat p-stat-accent warning">
          ...
          <div class="p-stat-delta">over the last quarter, all of it from dropped part-time shifts nobody was asked about. <span class="down">Down $180</span> since the question moved to the drop.</div>
        </div>
      </div>
    </div>'''
