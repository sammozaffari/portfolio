...
def timeclock():
    ...
    body = (
        ...
        'Break times sit beside each name, and a change made here stays on the chart.</p>'
...
def labour():
    body = (
        ...
        'The figures below are as at 13:04 today.</p>'
...
def reports():
    ...
    body = (
        ...
        'for any period past the thirty-day window.</p>'
...
def features():
    ...
    body = (
        ...
        '<p class="p-work-sub">What is switched on, where, and who is allowed to change it, '
        'restaurant by restaurant.</p>'
